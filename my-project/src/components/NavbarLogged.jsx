            ...
            <div className='px-2 flex justify-between items-center w-full h-full'>
                <div className='flex items-center'>
                    ...
                    <ul className='hidden md:flex'>
                        ...
                        <li className='hover:text-amber-500 no-underline transition duration-300 ease-in-out dark:text-white'> <a href="#About"> Services </a> </li>
                        <li className='hover:text-amber-500 no-underline transition duration-300 ease-in-out dark:text-white'> <a href="#Card"> Card </a> </li>
                    </ul>
                </div>
