...
const Services = () => {
    return (
       <div className='w-full mt-24' id='About'>
            <div className='w-full h-[550px] bg-gray-900/40 absolute'>
                <img className='w-full h-full object-cover mix-blend-overlay' src={img} alt="/" />
            </div>
        
            <div className='max-w-[1240px] mx-auto text-white relative'>
                <div className='px-4 py-12'>
                    <h2 className='text-3xl pt-8 text-slate-300 uppercase text-center'> UNDAbank. </h2>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl hover:scale-105 transition duration-300 ease-in-out'>
                        <div className='p-8'>
                            ...
                            <h3 className='font-bold text-2xl my-6 underline'> Pix </h3>
                    ...
                    <div className='bg-white rounded-xl shadow-2xl hover:scale-105 transition duration-300 ease-in-out'>
                        <div className='p-8'>
                            <BookmarkIcon className='w-5 mr-5 text-amber-500 hover:text-purple-500 transition duration-300 ease-in-out'/>
                            <h3 className='font-bold text-2xl my-6 underline'> Recharge </h3>
                    ...
                    <div className='bg-white rounded-xl shadow-2xl hover:scale-105 transition duration-300 ease-in-out'>
                        <div className='p-8'>
                            <BookmarkIcon className='w-5 mr-5 text-amber-500 hover:text-purple-500 transition duration-300 ease-in-out'/>
                            <h3 className='font-bold text-2xl my-6 underline'> Tickets </h3>
                    ...
                    <div className='bg-white rounded-xl shadow-2xl hover:scale-105 transition duration-300 ease-in-out'>
                        <div className='p-8'>
                            <BookmarkIcon className='w-5 mr-5 text-amber-500 hover:text-purple-500 transition duration-300 ease-in-out'/>
                            <h3 className='font-bold text-2xl my-6 underline'> Loan </h3>
                    ...
                    <div className='bg-white rounded-xl shadow-2xl hover:scale-105 transition duration-300 ease-in-out'>
                        <div className='p-8'>
                            <BookmarkIcon className='w-5 mr-5 text-amber-500 hover:text-purple-500 transition duration-300 ease-in-out'/>
                            <h3 className='font-bold text-2xl my-6 underline'> Cards </h3>
                    ...
                    <div className='bg-white rounded-xl shadow-2xl hover:scale-105 transition duration-300 ease-in-out'>
                        <div className='p-8'>
                            <BookmarkIcon className='w-5 mr-5 text-amber-500 hover:text-purple-500 transition duration-300 ease-in-out'/>
                            <h3 className='font-bold text-2xl my-6 underline'> Help </h3>
